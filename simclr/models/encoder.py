...
class EncodeProject(nn.Module):
    def __init__(self, hparams):
        ...
        if hparams.arch == 'ResNet50':
            ...
            self.convnet = simclr.models.resnet.ResNet50(cifar_head=cifar_head, hparams=hparams)
            self.encoder_dim = 2048
        elif hparams.arch == 'resnet18':
            self.convnet = simclr.models.resnet.ResNet18(cifar_head=(hparams.data == 'cifar'))
